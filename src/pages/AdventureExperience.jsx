...
const AdventuresSection = () => {
  ...
  return (
    <section id='adventures' className="py-16 bg-gray-50 p-4 border rounded-xl">
          ...
          {adventuresData.map((adventure) => (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <button onClick={() => navigate(`/adventure-details/${adventure.id}`)} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                  Explore Now
                </button>
              </div>
            </div>
